		...
		<tr>
			...
			<td vertical-align="middle">
				<table>
					...
					<tr>
						<td colspan="2">
							<span style="font-weight: 700; font-weight: bold; font-size: 14pt; color: rgb(26,83,92);">
								{{ form.name }}
							</span>
						</td>
					</tr>
					...
					<tr>
						<td colspan="2" style="padding-bottom: 10px; color: rgb(51,167,196); font-size: 14pt;">
