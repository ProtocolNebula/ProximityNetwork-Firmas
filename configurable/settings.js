...
var SETTINGS = {
     ...
     */
    companyInfo: {
        name: 'Proximity Network',
        websiteText: 'ProximityNetwork.es', // Text to show on website URL
        website: 'https://proximitynetwork.es', // URL to link
        direction: {
    ...
    socialNetworks: {
        ...
        facebook: 'https://www.facebook.com/ProximityNetwork',
        // twitter: 'https://wwww.twitter.com/YOURCOMPANYTWITTER',
        instagram: 'https://www.instagram.com/proximitynetwork/',
        linkedin: 'https://www.linkedin.com/company/proximity-network/about/',
    },
    sizes: {
